...
/*
// vanaf glib 2.50
GLogWriterOutput myGLogWriterFunc(GLogLevelFlags log_level,
...
/*
// ouder dan glib 2.50
void myGLogFunc(const gchar *log_domain, GLogLevelFlags log_level,
...
void run(char const *url, char const *title, int noHWAccel) {
    ...
    /*
    // vanaf glib 2.50
    g_log_set_writer_func(myGLogWriterFunc, NULL, NULL);
    */
    /*
    // ouder dan glib 2.50
    ...
    */
    ...
    g_signal_connect(window, "key-press-event",
                     G_CALLBACK(web_view_key_pressed), NULL);
